...
begin
  ...
  insert into proveedores_ucu (
    ...
    tiene_iso14001, tiene_fsc, tiene_emas, embalaje_sostenible,
  ...
  -- Productos aprobados de EcoPapel
  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_ecopapel, 'Cuaderno Universitario Eco 100 hojas', 'archivo', 150.00, 100, true, true, 'aprobado');

  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_ecopapel, 'Resma Reciclada A4 80g', 'papel', 290.00, 85, true, false, 'aprobado');

  -- Productos PENDIENTES enviados por EcoPapel después de ser aprobado
  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_ecopapel, 'Carpeta Cartón Reciclado A4', 'archivo', 95.00, 90, true, true, 'pendiente');

  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_ecopapel, 'Bloc Notas Kraft 80 hojas', 'papel', 120.00, 75, true, false, 'pendiente');
  ...
  -- Productos aprobados de PaperUY
  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_paperuy, 'Resma A4 75g Standard', 'papel', 245.00, 40, true, false, 'aprobado');

  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_paperuy, 'Carpeta Plástica A4', 'archivo', 85.00, 0, false, true, 'aprobado');

  -- Producto PENDIENTE enviado por PaperUY
  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_paperuy, 'Set Bolígrafos Reciclados x6', 'escritura', 175.00, 50, true, false, 'pendiente');
  ...
  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_delsur, 'Cuaderno Espiral 80 hojas', 'papel', 155.00, 60, true, false, 'aprobado');

  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_delsur, 'Caja Clips Metálicos x100', 'organización', 65.00, 90, true, true, 'aprobado');
  ...
  insert into proveedores_ucu (
    ...
    true, true, false, false,
    array['https://supabase.storage/certificados/oficenter_iso.pdf',
          'https://supabase.storage/certificados/oficenter_fsc.pdf'],
    null
  ) returning id into id_oficenter;

  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_oficenter, 'Resma Papel A4 Fotocopia 75g', 'papel', 240.00, 0, true, false, 'pendiente');

  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_oficenter, 'Marcadores Pizarra Azul x4', 'escritura', 180.00, 20, true, true, 'pendiente');

  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_oficenter, 'Tijeras Acero Inoxidable', 'organización', 95.00, 0, false, true, 'pendiente');
  ...
  insert into productos_ucu (proveedor_id, nombre, categoria, precio, mat_reciclados_pct, es_reciclable, es_reusable, estado)
  values (id_caribe, 'Bolígrafo Trazo Fino Negro', 'escritura', 45.00, 0, false, false, 'rechazado');
